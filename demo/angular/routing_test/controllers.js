...
function emailRouteConfig($routeProvider, $locationProvider){
    $routeProvider.
    when('/demo/angular/routing_test/', {
        controller: ListController,
        templateUrl: '/demo/angular/routing_test/list.html'
    }).
    // Notice that for the detail view, we specify a parameterized URL component by placing a colon in front of the id
    when('/demo/angular/routing_test/view/:id', {
        controller: DetailController,
        templateUrl: '/demo/angular/routing_test/detail.html'
    }).
    otherwise({
        redirectTo: '/demo/angular/routing_test/'
    });
